...
IBM {{site.data.keyword.Bluemix_notm}} 서비스는 귀하의 국가에서 사용할 수 있도록 귀하에게 제공되는 IBM 클라우드 서비스 계약의 조항([www.ibm.com/terms ![외부 링크 아이콘](../icons/launch-glyph.svg)](www.ibm.com/terms){: new_window} 참조)에 의거해서 이용이 가능하며 특정 {{site.data.keyword.Bluemix_notm}} 서비스에 관한 추가 조항을 포함한 최신 IBM {{site.data.keyword.Bluemix_notm}} 서비스 명세서는 [http://www-03.ibm.com/software/sla/sladb.nsf/sla/bm ![외부 링크 아이콘](../icons/launch-glyph.svg)](http://www-03.ibm.com/software/sla/sladb.nsf/sla/bm){: new_window}에서 확인할 수 있습니다. 
